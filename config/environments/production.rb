...
Rails.application.configure do
  ...
  config.action_cable.url = "wss://dogwalking-api.onrender.com/cable"
  config.action_cable.allowed_request_origins = [ "https://dogwalking-app.onrender.com", "http://localhost:5173/", /http:\/\/example.*/ ]
